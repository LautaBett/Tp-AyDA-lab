...
Nodo * obtenerPrimero(Nodo * & primero) {
    return primero; // Devuelve el primer nodo
}   

Nodo * obtenerUlimoNodo(Nodo * & primero){
    Nodo * actual = primero;
...
int main() {
    ...
    mostrar_elementos( obtenerUlimoNodo(mi_lista));
    mostrar_elementos(obtenerPrimero(mi_lista));

    Nodo* aux =  obtenerUlimoNodo(mi_lista);
    cout << aux ->elemento << endl;

    Nodo* aux2 =  obtenerPrimero(mi_lista);
    cout << aux2 ->elemento;
